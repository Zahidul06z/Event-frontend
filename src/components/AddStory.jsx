...
const AddStory = () => {
    ...
    const handleSubmit = async(e) =>{
      ...
      try {
        const res = await fetch(`/api/stories/createstory/${user?._id}`,{
          method: "POST",
          headers: {
        ...
        <form className='border-1 border-white py-2 px-2 mb-10 shadow-2xl sm:px-4' onSubmit={handleSubmit}>
            <div>
                <div className='flex justify-center border-1 border-white mt-4 mb-6'>
                  <button onClick={handleClick} className='text-white font-semibold my-2 cursor-pointer '>Upload Story Video or Image </button>
